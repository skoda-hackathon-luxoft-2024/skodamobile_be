...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        log.error("Validation fails {}", validationErrors);
    ...
    ResponseEntity<ErrorResponse> handleApiException(ApiException apiException) {
        ...
        log.error("API call fails {}", response);
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(value = {NoSuchElementException.class})
    ResponseEntity<ErrorResponse> handleNoSuchElementException(NoSuchElementException apiException) {
        final ErrorResponse response = new ErrorResponse(apiException.getMessage());
        log.error("NoSuchElementException {}", response);
    ...
    ResponseEntity<ErrorResponse> handleUnexpectedError(RuntimeException ex) {
        ...
        log.error("Runtime fails {}", response);
